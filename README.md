...
![Tech Stack](https://img.shields.io/badge/Stack-React_19_|_Vite_|_Socket.io_|_Groq_+_Tavily-blue?style=for-the-badge)

**ConstructPrice** es una plataforma SaaS diseñada para constructoras y ferreterías en Colombia que permite gestionar, actualizar y analizar los precios de materiales de construcción en tiempo real, potenciada por Inteligencia Artificial (Groq + Tavily).
...
- **Backend:** Node.js + Express + Socket.io (Puerto 3001). Actúa como proxy seguro hacia Groq y Tavily (las API Keys nunca se exponen en el navegador).
- **IA:** Groq API (modelo `llama-3.3-70b-versatile`) para razonar, y **Tavily** para la búsqueda web en tiempo real.
...
- **Groq** (IA, obligatoria): https://console.groq.com/keys
...
> El frontend pide los precios al backend, y el backend consulta Tavily (búsqueda web) y Groq (IA).
> Así las API Keys permanecen seguras en el servidor y no se expone en el navegador.

---

## ☁️ Despliegue en Vercel

El proyecto ya está listo para Vercel. Los endpoints de la API corren como **funciones
